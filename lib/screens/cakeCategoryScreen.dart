...
class CakeCategoryScreen extends StatefulWidget {
  ...
  const CakeCategoryScreen(
      {Key? key, required this.childCategoryId, required this.categoryId})
      : super(key: key);
...
class _CakeCategoryScreenState extends State<CakeCategoryScreen> {
  ...
  Future<void> _loadMoreItems() async {
    ...
    if (lowToHigh) {
      allItems.sort((a, b) => a
          .weightPriceOffer[a.weightPriceOffer.keys.toList()[0]]
          .compareTo(b.weightPriceOffer[b.weightPriceOffer.keys.toList()[0]]));
    }

    if (highToLow) {
      allItems.sort((a, b) => b
          .weightPriceOffer[b.weightPriceOffer.keys.toList()[0]]
          .compareTo(a.weightPriceOffer[a.weightPriceOffer.keys.toList()[0]]));
    }
  ...
  Widget _buildMenu(
      BuildContext context, Cake menuItem, int index, int length) {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => CakeItemScreen(
                                        ...
                                        cake: items[index],
                                        categoryMainId: widget.categoryId,
                                      )),
                            );
                          },
                          child: Row(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      allItems.sort((a, b) => b
                          .weightPriceOffer[b.weightPriceOffer.keys.toList()[0]]
                          .compareTo(a.weightPriceOffer[
                              a.weightPriceOffer.keys.toList()[0]]));
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      allItems.sort((a, b) => a
                          .weightPriceOffer[a.weightPriceOffer.keys.toList()[0]]
                          .compareTo(b.weightPriceOffer[
                              b.weightPriceOffer.keys.toList()[0]]));
